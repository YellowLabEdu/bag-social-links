...
export default function BagSocialLinks() {
  ...
  return (
      <div className={theme ? "bg-gradient-02 min-h-256 md:min-h-260 md:scale-130 lg:scale-100 flex items-center justify-center gap-6" : "bg-gradient-01 min-h-240 md:min-h-260 md:scale-130 lg:scale-100 flex items-center justify-center gap-6"}  >
    ...
    <div className="bg-(--color-white) w-84 h-88 rounded-2xl flex flex-col items-center justify-center gap-6">
      ...
      <div className=" w-80 flex flex-col items-center gap-10">
       ...
       text-white font-semibold hover:scale-95 transition-transform duration-200 cursor-pointer"
        onClick={() => window.open('https://www.instagram.com/yellowbagedu?igsh=MTY0eXVrb2VzeHlmbA==', '_blank', 'noopener,noreferrer')}
        > SAIBA MAIS</button>
      </div>
    </div>
    </ModalBag>}
      ...
      <div className="bg-white w-80 h-58 rounded-2xl flex flex-col gap-6">
          ...
          <div  className="flex justify-center items-center gap-6">
            <div className="flex flex-col justify-center items-center gap-4">
              <a className="cursor-pointer" href="https://www.instagram.com/lafocameta?igsh=dmZwaGZ4cGlpdzQx" target="_blank" rel="noopener noreferrer">
                <img src={LaFoca} alt={`LaFoca logo`} />
              </a>
              <span>@LAFoca</span>
            </div>
            <div className="flex flex-col justify-center items-center gap-4">
              <a className="cursor-pointer" href="https://www.instagram.com/shmusic.escola2?igsh=MTM2MGs2bWZ1aTBxeA==" target="_blank" rel="noopener noreferrer">
