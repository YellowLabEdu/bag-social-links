...
export default function BagSocialLinks() {
  ...
  return (
      <div className={Mode ? "bg-gradient-02 min-h-240 md:min-h-320 md:scale-130 lg:scale-100 flex items-center justify-center gap-6" : "bg-gradient-01 min-h-240 md:min-h-320 md:scale-130 lg:scale-100 flex items-center justify-center gap-6"}  >
