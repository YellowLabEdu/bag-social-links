...
export default function BagSocialLinks() {
  ...
  return (
      <div className={ theme ? "bg-gradient-02 min-h-230 md:min-h-screen flex items-center justify-center gap-2" : "bg-gradient-01 min-h-230 md:min-h-screen flex items-center justify-center gap-2" }  >
    ...
    <div className="bg-white w-84 h-88 rounded-2xl flex flex-col items-center justify-center gap-10">
      <button
