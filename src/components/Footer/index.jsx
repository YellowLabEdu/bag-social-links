...
const baseFooterClass = "w-64 h-16 flex items-center justify-center gap-8 rounded-3xl bg-(--color-color-yellow) border-4 border-(--color-color-light-white) p-1 shadow-lg hover:scale-95 transition-transform duration-200";
