...
export function Footer({Color}) {
    const baseFooterClass = `w-64 h-16 z-1 ${Color} flex items-center justify-center gap-6 rounded-2xl border-4 border-(--color-white) p-2 shadow-lg hover:scale-95 transition-transform duration-200 cursor-pointer`;
